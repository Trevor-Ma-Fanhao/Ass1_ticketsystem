...
public class PassengerTest {
    ...
    public void testPassengerAllFieldsRequired() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> new Passenger("Fanhao", "Ma", 25, "Man", null, "+61481888206",
                "88888","88888",88888));
        Assertions.assertThrows(NullPointerException.class, () -> new Passenger("Fanhao", "Ma", 25, "Man", "932952939@qq.com", null,
                "88888","88888",88888));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Passenger("Fanhao", "Ma", 25, "Man", "932952939@qq.com", "+61481888206",
                null,"88888",88888));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Passenger("Fanhao", "Ma", 25, "Man", "932952939@qq.com", "+61481888206",
                "88888",null,88888));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Passenger("Fanhao", "Ma", 25, "Man", "932952939@qq.com", "+61481888206",
    ...
    public void validateAustralianPhoneNumber(){
        Assertions.assertThrows(IllegalArgumentException.class,()-> new Passenger("Fanhao", "Ma", 24, "Man", "932952939@qq.com",
    ...
    public void validateEmailAddress(){
        Assertions.assertThrows(IllegalArgumentException.class,()-> new Passenger("Fanhao", "Ma", 24, "Man", "932952939",
